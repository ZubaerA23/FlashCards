    ...
    <AppBar position = "static">
      ...
      <Box sx={{
        ...
        <Typography variant = "h5" gutterBottom>
          {' '}
          The easiest way to make flashcards from their text
        </Typography>
      ...
      <Box sx = {{my: 6}}>
        ...
        <Grid container spacing = {4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography>
              {' '}
             Access your flashcards from anywhere, at any time. 
            </Typography>
          </Grid>
        </Grid>
      </Box>
      ...
      <Grid container spacing = {4}>
          ...
          >
            ...
            <Typography>
              {' '}
             Access to basic flshcard features and limited storage
            </Typography>
            <Button variant = "contained" color = "primary" sx={{mt: 2}}>
              Choose Basic 
            </Button>
